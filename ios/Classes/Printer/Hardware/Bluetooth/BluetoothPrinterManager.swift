...
let PRINTER_DENSITY = 384
let FONT_DENSITY_NORMAL = 12
let FONT_DENSITY_SMALL = 9

public let PRINT_TEXT_SMALL_LENGTH = PRINTER_DENSITY/FONT_DENSITY_SMALL
public let PRINT_TEXT_NORMAL_LENGTH = PRINTER_DENSITY/FONT_DENSITY_NORMAL
public let PRINT_ITEM_LENGTH = PRINT_TEXT_NORMAL_LENGTH - " 9.999.999".count
...
public class BluetoothPrinterManager {
    ...
    public func print(_ content: ESCPOSCommandsCreator, encoding: String.Encoding = String.GBEncoding.GB_18030_2000, progressBlock: ((CGFloat) -> ())? = nil, completeBlock: ((PError?) -> ())? = nil) {
        ...
        for i in 0..<data.count {
            p.writeValue(data[i], for: c, type: .withoutResponse)
